...
export function Hero() {
  ...
  return (
    <Section id={sectionIds.home} className="section-divider overflow-hidden pt-6 sm:pt-10 lg:pt-12">
      <div className="hero-aura relative overflow-hidden rounded-[1.8rem] border border-white/10 px-4 py-6 text-white shadow-panel sm:rounded-[2.4rem] sm:px-8 sm:py-10 lg:px-10 lg:py-12">
        ...
        <div className="relative grid items-center gap-8 sm:gap-10 lg:grid-cols-[1.02fr_0.98fr] lg:gap-16">
          ...
          >
            ...
            <h1 className="mt-4 max-w-4xl font-display text-balance text-[2.05rem] font-semibold leading-[1.02] text-white sm:mt-6 sm:text-[3.7rem] sm:leading-[0.92] lg:text-[5rem]">
              {company.hero.title}
            </h1>
            ...
            <div className="mt-8 grid gap-3 min-[520px]:grid-cols-2 md:mt-10 md:grid-cols-3 md:gap-4">
              <div className="rounded-[1.4rem] border border-white/10 bg-white/[0.08] p-4 backdrop-blur-xl sm:rounded-[1.6rem] sm:p-5">
              ...
              <div className="rounded-[1.4rem] border border-white/10 bg-white/[0.08] p-4 backdrop-blur-xl min-[520px]:col-span-2 md:col-span-1 sm:rounded-[1.6rem] sm:p-5">
          ...
          >
            <div className="soft-panel overflow-hidden rounded-[1.9rem] border border-white/10 p-2.5 shadow-panel sm:rounded-[2.2rem] sm:p-3">
              <div className="relative overflow-hidden rounded-[1.5rem] sm:rounded-[1.7rem]">
                <img src="structure.png" alt="Imagem do maquinário" className="h-[17rem] w-full object-cover sm:h-[25rem]" width="800" height="400" />
                <div className="absolute inset-0 bg-gradient-to-t from-ink/68 via-ink/10 to-transparent" aria-hidden="true" />
                <div className="absolute bottom-3 left-3 right-3 rounded-[1.2rem] border border-white/10 bg-ink/84 p-3.5 text-white backdrop-blur-xl sm:bottom-4 sm:left-4 sm:right-4 sm:rounded-[1.4rem] sm:p-4">
